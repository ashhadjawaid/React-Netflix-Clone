...
import endpoints, { createImageUrl } from '../services/movieServices.jsx';
            ...
            <div className='absolute w-full h-[550px] lg:h-[850px] bg-gradient-to-r from-black'/>
                <img
                 ...
                 <div className='absolute w-full top-[20%] lg:top[25%] p-4 md:p-8'>
                    ...
                    <p className='w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200'>{truncate(overview, 300)}</p>
                 </div>
        </div>
    </div>
  )
